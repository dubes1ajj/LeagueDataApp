...
const ANALYSIS_WEIGHT_FIELDS: Array<{ key: AnalysisMetricKey; label: string }> = [
  ...
  { key: 'clutchPerformance', label: 'Clutch Holes' },
  { key: 'bounceBack', label: 'Bounce-Back' },
  { key: 'cleanCard', label: 'Clean Cards' },
  { key: 'ceilingFloor', label: 'Ceiling vs Floor' },
  { key: 'handicapOutperformance', label: 'Handicap Outperformance' },
...
const ANALYSIS_WEIGHT_PRESETS: Array<{
  ...
  },
  {
    ...
    weights: {
      ...
      topThreeRate: 0.04,
      topFiveRate: 0.06,
      clutchPerformance: 0.03,
      bounceBack: 0.08,
      cleanCard: 0.1,
      ceilingFloor: 0.09,
      handicapOutperformance: 0.03,
      momentum: 0.02,
      clutchFactor: 0.02,
    },
  },
  {
    ...
    weights: {
      ...
      topThreeRate: 0.08,
      topFiveRate: 0.05,
      clutchPerformance: 0.1,
      bounceBack: 0.05,
      cleanCard: 0.03,
      ceilingFloor: 0.02,
      handicapOutperformance: 0.05,
      momentum: 0.14,
      clutchFactor: 0.1,
    },
  },
